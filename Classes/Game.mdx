...
```lua
local ChatService = Game:GetService("ChatService") -- Some services like ChatService can only be accessed by Serversided Scripts.
ChatService.Push("This message is sent by the server and all clients can see it!")
```
